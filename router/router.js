...
const { firstGet, firstPost, register, login, updateUser, adPost, getUserAds, getUserDetails, getAllAds } = require('../controller/controller')
...
router.get('/getAllAds/:userId', getAllAds);
